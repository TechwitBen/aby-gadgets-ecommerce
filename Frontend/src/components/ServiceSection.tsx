  ...
  return (
    <section className="mb-16 sm:mb-20 md:mb-[100px] bg-background">
      <div className="container mx-auto px-4 sm:px-6">
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-8 sm:mb-12">Services We Offer</h2>
        ...
        <div className="space-y-4  sm:space-y-8">
          {services3.map((service, index) => (
            <div
              ...
              } items-stretch overflow-hidden rounded-2xl sm:rounded-3xl`}
              style={{ backgroundColor: "hsl(150 30% 92%)" }}
            >
              {/* Image */}
              <div className="w-full md:w-[45%] flex-shrink-0">
                <div className={`h-44 sm:h-56 md:h-72 overflow-hidden ${
                  service.align === "right" ? "md:rounded-l-[60px] lg:rounded-l-[80px]" : "md:rounded-r-[60px] lg:rounded-r-[80px]"
                }`}>
                  <img
                    src={service.image}
                    alt={service.title}
              ...
              <div className="w-full md:w-[55%] p-5 sm:p-8 md:p-10 lg:p-12 flex flex-col justify-center">
                ...
                <div>
                  <Button className="bg-primary text-primary-foreground hover:bg-primary/90 text-white font-semibold px-5 sm:px-6 py-2 rounded-xl text-xs uppercase tracking-wide">
                    {service.buttonText}
                  </Button>
                </div>
              </div>
