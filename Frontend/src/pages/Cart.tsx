        ...
        <div className="container mx-auto px-3 sm:px-4 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-base sm:text-lg font-bold text-gray-900">
              Cart{items.length > 0 && <span className="ml-2 text-sm font-normal text-gray-500">({items.length})</span>}
            </h1>
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-6">
        {items.length === 0 ? (
          <div className="text-center py-16 sm:py-24">
            ...
            <p className="text-gray-500 text-sm mb-6">Add some gadgets and come back!</p>
            <Link to="/products">
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-gray-500 mb-2">
                          {[item.color, item.storage, item.sku && `SKU: ${item.sku}`]
                            .filter(Boolean)
                            .join(" · ")}
                        </p>
      ...
      {items.length > 0 && (
        <div className="sm:hidden fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-gray-200 shadow-2xl">
          <div className="px-4 py-3">
            ...
            {!isAuthenticated && (
              <p className="text-xs text-center text-gray-400 mt-2">You'll be asked to sign in.</p>
            )}
          </div>
        </div>
      )}
