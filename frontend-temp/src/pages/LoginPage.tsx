...
/**
 * OAuthButtons now accepts `redirectTo` and passes it directly to the
 * oauthHelpers so the backend redirect URL is preserved through the OAuth flow.
 */
const OAuthButtons = ({
  isLoading,
  redirectTo,
  ...
  <>
    <div className="relative my-5">
      ...
      <div className="relative flex justify-center text-sm">
        <span className="px-4 bg-white text-gray-500">{dividerLabel}</span>
      </div>
    </div>
    ...
    <div className="space-y-3">
      <Button
        ...
        disabled={isLoading}
        onClick={() => oauthHelpers.loginWithGoogle(redirectTo)}
      >
      ...
      <Button
        ...
        className="w-full border-gray-200 text-gray-700 hover:bg-gray-50 gap-2 h-11"
        disabled={isLoading}
        onClick={() => oauthHelpers.loginWithFacebook(redirectTo)}
      >
